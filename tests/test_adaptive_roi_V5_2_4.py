# ==========================================
# 파일명: adaptive_roi_test_V5_2_4.py
# 설명:
# adaptive ROI 테스트 코드
#
# 기능
# 1) 초기 100프레임 동안 y2 buffer 수집
# 2) percentile 기반 ROI 자동 계산
...
#
# 목적
# - CCTV 고정 환경에서 차량 하단(y2) 분포 기반 ROI를 사용하되
#   ROI가 지나치게 좁아지지 않도록 최소 높이를 보장하는지 검증
# ==========================================
...
class AdaptiveROI:
    ...
    # =========================================================
    # percentile 기반 ROI 계산
    # =========================================================
    def _compute_raw_roi(self):
        """
        차량 y2 분포를 바탕으로 raw ROI 계산
        """
...
# VIDEO_PATH = r"d:/Finalpj_tunnel_V3/smart_tunnel_V3_data/raw_video/test_video/test_normal_1.mp4"
VIDEO_PATH = r"d:/Finalpj_tunnel_V3/smart_tunnel_V3_data/raw_video/test_video/test_accident_2.mp4"
