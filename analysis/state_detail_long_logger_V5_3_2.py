# ==========================================
# 파일명: state_detail_long_logger_V5_3_2.py
# 설명:
...
print("🚀 STATE DETAIL LONG LOGGER V5_3_2 시작")
...
DETAIL_LONG_LOG_PATH = os.path.join(
    OUTPUT_DIR,
    f"state_detail_long_log_v5_3_2_{timestamp}.csv"
)
...
def main():
    ...
    pipeline = PipelineCore(
        frame_height=height,
        lane_output_dir=None   # 그래프 저장 최소화
    )
