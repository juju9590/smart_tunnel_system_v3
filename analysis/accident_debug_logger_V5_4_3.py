# ==========================================
# 파일명: accident_debug_logger_V5_4_3.py
# 위치: analysis/
# 설명:
# - pipeline 코드는 수정하지 않고
# - analysis 폴더에서 별도 실행하여
# - V5.4.3 사고 디버그 CSV를 저장하는 스크립트
...
# 출력 폴더
OUTPUT_DIR = os.path.join(OUTPUT_ROOT, "analysis_v5_4_3")
...
# =========================================================
try:
    from traffic_accident_V5_4_3 import AccidentDetector
except Exception as e:
    raise ImportError(
        f"[오류] traffic_accident_V5_4_3 import 실패\n"
    ...
    def log(self, debug_info):
        ...
        for pair in pairs:
            ...
            self.writer.writerow([
                ...
                pair.get("weak_candidate", False),
                pair.get("strong_candidate", False),
...
def main():
    ...
    csv_path = os.path.join(OUTPUT_DIR, f"accident_debug_v5_4_2_{timestamp}.csv")
