...
class AccidentDetector:
    ...
    # pair 충돌 후보 분석
    # =========================================================
    def _analyze_pair_collision(self, frame_id, vehicle_infos):
        """
        ...
        return pair_collision_count, pair_debug
    ...
    def update(self, frame_id, tracks, analysis):
        ...
        # 2) pair 충돌 후보 분석
        # -----------------------------------------------------
        pair_collision_count, pair_debug = self._analyze_pair_collision(
            frame_id=frame_id,
        ...
        if traffic_state in ["JAM", "CONGESTION"]:
            ...
            pair_collision_valid = pair_evidence_raw
